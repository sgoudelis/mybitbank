...
class UserSettings(object):
    ...
    def set(self, name, value):
        ...
        if existing:
            ...
            new_setting = login.models.Setting(user_id=self.user_id, name=name, value=value)
            new_setting.save()
            return True

    def get(self, name):
        try:
            stored_settings = login.models.Setting.objects.filter(user_id=self.user_id, name=name)
