# Django settings for mybitbank project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mybitbank.sqlite3',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'o@!n5j6(^2j!#jyfr(h=n)91n%ch-aycob@dwkqneala#2v1es'
...
WSGI_APPLICATION = 'mybitbank.wsgi.application'
