...
from connections.coinaccount import CoinAccount
...
class CoinWallet(object):
    ...
    def getNet(self):
        ...
        if cached_peerinfo:
            ...
            info = connections.connector.getinfo(self.provider_id)
    ...
    def listAccounts(self, gethidden=False, getarchived=False):
        ...
        fresh_accounts = connections.connector.listAccounts(gethidden=False, getarchived=False, selected_provider_id=self.provider_id)
    ...
    def listTransactions(self, limit=10, start=0):
        ...
        transactions = []
        transactions_dicts = connections.connector.listTransactionsByAccount("*", self.provider_id, limit, start)
    ...
    def getTransactionById(self, txid):
        ...
        transaction_details = connections.connector.getTransaction(txid, self.provider_id)
    ...
    def getAddressesByAccount(self, account):
        ...
        '''
        addresses_list = connections.connector.getAddressesByAccount(account, self.provider_id)
        coinaddresses = []
